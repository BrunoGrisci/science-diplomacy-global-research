...
def main():
    ...
    centrality_df.to_csv(csv_final_path.replace('.csv', '_authors_centrality.csv'), index=False)
    ...
    pyvis_graph.show(csv_final_path.replace('.csv', '_authors.html'), notebook=False)
