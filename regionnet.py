...
def main():
    ...
    # Columns to keep
    columns_to_keep = ['affiliation_country', 'affiliation_subregion_manual', 'affiliation_region_manual', 'target_country_manual', 'target_subregion_manual', 'target_region_manual', 'target_other_manual', 'SD-related (YES/NO)', 'coverDate']
    ...
    # Drop rows where 'target_other_manual' is "None"
    df = df[df['target_other_manual'].str.lower() != 'none']
    ...
    for _, row in df.iterrows():
        ...
        if not all_elements_same_length([target_countries, target_subregion, target_region, target_other]):
        ...
        target_list = first_non_none_elements([target_countries, target_subregion, target_region, target_other])
    ...
    counter_file = csv_file_path.replace('.csv', '_counter_results.csv')
    ...
    centrality_df.to_csv(csv_file_path.replace('.csv', '_centrality.csv'), index=False)
    ...
    pyvis_graph.show(csv_file_path.replace('.csv', '.html'), notebook=False)
